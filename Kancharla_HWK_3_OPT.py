...
data = DataPortal()
data.load(filename = '2022_ERCOT_data.csv', select = ('t', 'solar'), param = model.solar, index = model.t)
data.load(filename = '2022_ERCOT_data.csv', select = ('t', 'wind'), param = model.wind, index = model.t)
data.load(filename = '2022_ERCOT_data.csv', select = ('t', 'demand'), param = model.demand, index = model.t)
